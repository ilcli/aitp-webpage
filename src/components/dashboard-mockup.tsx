    ...
    <div className="mx-auto max-w-4xl">
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {/* Metric 1 */}
          <div className="rounded-lg border border-primary-200 bg-gradient-to-br from-primary-50 to-primary-100 p-4 dark:border-primary-700 dark:from-primary-900/30 dark:to-primary-800/30">
          ...
          {/* Metric 2 */}
          <div className="rounded-lg border border-accent-200 bg-gradient-to-br from-accent-50 to-accent-100 p-4 dark:border-accent-700 dark:from-accent-900/30 dark:to-accent-800/30">
            <div className="mb-2 flex items-center justify-between">
              <div className="rounded-md bg-accent-500 p-2">
                <svg
                  className="h-4 w-4 text-white"
                  fill="none"
                  stroke="currentColor"
          ...
          {/* Metric 3 */}
          <div className="rounded-lg border border-green-200 bg-gradient-to-br from-green-50 to-green-100 p-4 dark:border-green-700 dark:from-green-900/30 dark:to-green-800/30">
            <div className="mb-2 flex items-center justify-between">
        ...
        {/* Mini Chart */}
        <div className="mt-6 rounded-lg border border-accent-200 bg-accent-50 p-4 dark:border-accent-700 dark:bg-accent-800/50">
          <div className="mb-3 flex items-center justify-between">
            <h4 className="text-sm font-medium text-accent-700 dark:text-accent-300">
              {t("processingVolume")}
            </h4>
            <span className="text-xs text-accent-500">{t("last30Days")}</span>
          </div>
          <div className="flex h-16 items-end space-x-1">
            {[40, 65, 45, 80, 55, 90, 75, 85, 70, 95, 85, 100].map(
              (height, i) => (
                <div
                  key={i}
                  className="flex-1 rounded-sm bg-gradient-to-t from-primary-600 to-primary-400 transition-all duration-1000 ease-out"
                  style={{
                    height: `${height}%`,
